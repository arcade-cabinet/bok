...
export const BIOME_PROPS: Record<string, PropConfig[]> = {
  forest: [
    ...
    { modelFile: 'tree', density: 0.02 },
    { modelFile: 'tree1', density: 0.015 },
    { modelFile: 'tree2', density: 0.015 },
    ...
    { modelFile: 'grassmushroom', density: 0.02 },
    { modelFile: 'grass1', density: 0.03 },
    { modelFile: 'grass2', density: 0.03 },
    { modelFile: 'grass3', density: 0.03 },
    { modelFile: 'grassflower1', density: 0.02 },
    { modelFile: 'grassflower2', density: 0.02 },
    { modelFile: 'Rock1', density: 0.01 },
    { modelFile: 'box1', density: 0.005 },
    { modelFile: 'box2', density: 0.005 },
  ],
  desert: [
    { modelFile: 'Rock1', density: 0.03 },
    { modelFile: 'Rock2', density: 0.02 },
    { modelFile: 'Grass_Small', density: 0.01 },
    { modelFile: 'nograss', density: 0.02 },
    { modelFile: 'walktile', density: 0.01 },
  ],
  tundra: [
    ...
    { modelFile: 'nograss', density: 0.015 },
  ],
  volcanic: [
  ...
  swamp: [
    ...
    { modelFile: 'grass1', density: 0.02 },
    { modelFile: 'grass3', density: 0.02 },
  ],
  'crystal-caves': [
  ...
  'sky-ruins': [
    ...
    { modelFile: 'Rock2', density: 0.01 },
    { modelFile: 'walktile', density: 0.01 },
    { modelFile: 'nograss', density: 0.01 },
  ],
  'deep-ocean': [
    { modelFile: 'Plant_2', density: 0.03 },
    { modelFile: 'Plant_3', density: 0.02 },
    { modelFile: 'grass2', density: 0.02 },
    { modelFile: 'grass3', density: 0.01 },
  ],
};
