    ...
    <div className="modal modal-open overlay-safe-area">
      ...
      <div className="modal-box card bg-base-100 border-2 border-secondary max-w-xs sm:max-w-md text-center">
        ...
        {stats.tomePageUnlocked && stats.abilityName && (
          <div className="card bg-base-200/50 border-2 border-warning/50 mb-4 p-4 shadow-lg">
        ...
        <div className="flex flex-col gap-2">
          <button type="button" className="btn btn-primary w-full" onClick={onContinueVoyage}>
            CONTINUE VOYAGE
          </button>
          <button type="button" className="btn btn-ghost border border-secondary w-full" onClick={onReturnToHub}>
            RETURN TO HUB
          </button>
        </div>
      </div>
